...
class Discriminator(QACNN):
    ...
    def __init__(self, sequence_length, batch_size,vocab_size, embedding_size,
				 filter_sizes, num_filters, dropout_keep_prob=1.0,
				 l2_reg_lambda=0.0,learning_rate=1e-2,paras=None,
                 embeddings=None,loss="pair",trainable=True):
        
        with tf.name_scope("QACNN_init") as scope:
            QACNN.__init__(self, sequence_length, batch_size,vocab_size,
        ...
        with tf.name_scope("dis_output") as scope:
        ...
        with tf.name_scope("dis_optimizer") as scope:
